...
async def play_transfer_to_agent(websocket, customer_number: str, call_sid: str, customer_name: str = None, language_code: str = "en-IN"):
    ...
    try:
        ...
        transfer_message = get_localized_prompt("transfer", language_code, name=customer_name or customer_number)
        await play_audio_message(websocket, transfer_message, language_code=language_code)
